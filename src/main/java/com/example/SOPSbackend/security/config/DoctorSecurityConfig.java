...
@Component
@Order(2)
public class DoctorSecurityConfig extends UserSecurityConfig<DoctorEntity> {

    public DoctorSecurityConfig(PasswordEncoder passwordEncoder, BasicUserService<DoctorEntity> userService,
