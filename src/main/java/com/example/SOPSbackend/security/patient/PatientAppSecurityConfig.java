...
@Configuration
@Order(3)
public class PatientAppSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public PatientAppSecurityConfig(PasswordEncoder passwordEncoder, PatientUserService patientUserService,
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        .and()
        .addFilter(patientAuthenticationFilter())
        .addFilter(patientAuthorizationFilter())
        .exceptionHandling()
    ...
    protected void configure(AuthenticationManagerBuilder auth) {
        ...
        provider.setUserDetailsService(patientUserService);
        provider.setPasswordEncoder(passwordEncoder);
        auth.authenticationProvider(provider);
    }

    @Bean(name="AuthenticationPatientFilter")
    public JsonObjectAuthenticationFilter patientAuthenticationFilter() throws Exception {
        var authFilter = new JsonObjectAuthenticationFilter(objectMapper);
        authFilter.setFilterProcessesUrl("/patient/login");
    ...
    @Bean(name="AuthorizationPatientFilter")
    public JwtAuthorizationFilter patientAuthorizationFilter() throws Exception {
        return new JwtAuthorizationFilter(super.authenticationManager(),
                patientUserService, tokenSecret);
    }
}