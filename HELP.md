...
* The original package name 'com.example.SOPS-backend' is invalid and this project uses 'com.example.SOPSbackend' instead.
...
### Additional Links
These additional reference should also help you:
